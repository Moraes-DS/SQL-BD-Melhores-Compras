...
--Criando a sequência da coluna CD_BAIRRO
CREATE SEQUENCE SQ_CD_BAIRRO --Nome da sequência usada na tabela MC_BAIRRO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 99999999 --Isso pq o tipo de dado da coluna CD_BAIRRO é NUMBER 8 (8 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma sequência para a coluna CD_CATEGORIA
CREATE SEQUENCE SQ_CD_CATEGORIA --Nome da sequência usada na tabela MC_CATEGORIA_PROD
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    NOMAXVALUE --Essa coluna não tem o número de caracteres estipulado
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma sequência para a coluna CD_CIDADE
CREATE SEQUENCE SQ_CD_CIDADE --Nome da sequência usada na tabela MC_CIDADE
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 99999999 --Isso pq o tipo de dado da coluna CD_CIDADE é NUMBER 8 (8 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando a sequência para a coluna NR_CLIENTE
CREATE SEQUENCE SQ_NR_CLIENTE --Nome da sequência usada na tabela MC_CLIENTE
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 9999999999 --Isso pq o tipo de dado da coluna NR_CLIENTE é NUMBER 10 (10 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando a sequência da coluna CD_DEPTO
CREATE SEQUENCE SQ_CD_DEPTO --Nome da sequência usada na tabela MC_DEPTO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 999 --Isso pq o tipo de dado da coluna CD_DEPTO é NUMBER 3 (3 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma SEQUENCE para a coluna CD_FUNCIONARIO
CREATE SEQUENCE SQ_CD_FUNCIONARIO --Nome da sequência usada na tabela MC_FUNCIONARIO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 9999999999 --Isso pq o tipo de dado da coluna CD_FUNCIONARIO é NUMBER 9 (9 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando a sequência para CD_LOGRADOURO
CREATE SEQUENCE SQ_CD_LOGRADOURO --Nome da sequência usada na tabela MC_LOGRADOURO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 9999999999 --Isso pq o tipo de dado da coluna CD_LOGRADOURO é NUMBER 10 (10 dígitos)
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma sequência para a coluna CD_PRODUTO
CREATE SEQUENCE SQ_CD_PRODUTO --Nome da sequência usada na tabela MC_PRODUTO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 9999999999 --Essa coluna tem número de caracteres = 10
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma sequência para a coluna NR_SEQUENCIA
CREATE SEQUENCE SQ_NR_SEQUENCIA --Nome da sequência usada na tabela MC_SGV_PRODUTO_VIDEO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 999 --Essa coluna tem número de caracteres = 3
    NOCACHE --Não seriam criados números previamente (evita gaps)
    NOCYCLE --Não reinicia a sequência
    ORDER;
...
--Criando uma sequência para a coluna CD_VISUALIZACAO_VIDEO
CREATE SEQUENCE SQ_CD_VISUALIZACAO_VIDEO --Nome da sequência usada na tabela MC_SGV_VISUALIZACAO_VIDEO
    START WITH 1 --Valor inicial da sequência
    INCREMENT BY 1 --Valor do incremento (de 1 em 1)
    MAXVALUE 9999999999 --Essa coluna tem número de caracteres = 10
    NOCACHE --Não seriam criados números previamente (evita gaps)
